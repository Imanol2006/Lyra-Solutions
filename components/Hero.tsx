  ...
  >
    <defs>
      <radialGradient id="vg" cx="50%" cy="17%" r="32%">
        <stop offset="0%" stopColor="#6365EF" stopOpacity=".14" />
        <stop offset="100%" stopColor="#6365EF" stopOpacity="0" />
      </radialGradient>
    </defs>
    ...
    <text x="213" y="81" fill="rgba(99,101,239,0.55)" fontFamily="var(--font-syne),sans-serif" fontSize="9.5" letterSpacing=".07em">Vega</text>
    <text x="281" y="197" fill="rgba(99,101,239,0.55)" fontFamily="var(--font-syne),sans-serif" fontSize="9.5" letterSpacing=".07em">ζ</text>
    <text x="116" y="201" fill="rgba(99,101,239,0.55)" fontFamily="var(--font-syne),sans-serif" fontSize="9.5" letterSpacing=".07em" textAnchor="end">ε</text>
    <text x="132" y="351" fill="rgba(99,101,239,0.55)" fontFamily="var(--font-syne),sans-serif" fontSize="9.5" letterSpacing=".07em">β</text>
    <text x="281" y="353" fill="rgba(99,101,239,0.55)" fontFamily="var(--font-syne),sans-serif" fontSize="9.5" letterSpacing=".07em">γ</text>
    <text x="200" y="435" textAnchor="middle" fontFamily="var(--font-syne),sans-serif" fontSize="11" letterSpacing=".28em" fill="rgba(99,101,239,.3)" fontWeight="600">LYRA</text>
  </svg>
)
  ...
  return (
    <section
      ...
      style={{
        ...
        alignItems: 'center',
        zIndex: 1,
        padding: 'clamp(200px,22vh,240px) clamp(22px,4vw,48px) 80px',
        overflow: 'hidden',
      }}
    >
      {/* Text content */}
      ...
      >
        <div style={{
          ...
          textTransform: 'uppercase', color: '#6365EF', marginBottom: 26,
        }}>
          <span style={{ width: 4, height: 4, background: '#6365EF', borderRadius: '50%', display: 'inline-block' }} />
        ...
        <h1 style={{
          ...
          <em style={{ fontStyle: 'normal', color: '#6365EF' }}>Are they finding you?</em>
        </h1>
        ...
        <a
          ...
          style={{
            ...
            background: '#6365EF', color: '#fff', textDecoration: 'none',
            fontFamily: 'var(--font-syne), sans-serif',
          ...
          onMouseEnter={e => {
            ...
            e.currentTarget.style.boxShadow = '0 12px 32px rgba(99,101,239,0.35)'
          }}
          onMouseLeave={e => {
